...
export function LinkedInButton() {
  return (
    <a href="https://www.linkedin.com/in/charles-buffington/" target="_blank">
      <Button variant="outline" size="icon" className="p-1.5 opacity-70 hover:opacity-90 transition-opacity border-2">
  ...
  return (
    <a href={props.href} className="group/test">
      <Button variant="outline" className="text-white/70 group-hover/test:text-white/95">
        <span className="mr-1 group-hover/test:underline group-hover/test:underline-offset-1">{props.label}</span>
